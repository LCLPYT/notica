...
public enum NoticaPermissions {
    ...
    COMMAND_PLAYLIST_CREATE("command.playlist.create"),
    COMMAND_PLAYLIST_SHARE("command.playlist.share"),
    COMMAND_PLAYLIST_SHARE_PUBLIC("command.playlist.share.public"),
    ;
